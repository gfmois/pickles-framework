<form method="post" class="max-w-md mx-auto bg-white p-8 rounded shadow">
    ...
    <div class="mb-6">
        ...
        <input value="<?= old('name') ?>" type="text" id="name" name="name"  class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
        <div class="text-red-500"><?= error('name') ?></div>
    </div>
    ...
    <div class="mb-6">
        <label for="confirm_password" class="block text-gray-700 font-bold mb-2">Confirm Passowrd</label>
        <input type="password" value="<?= old('confirm_password') ?>" type="password" id="confirm_password" name="confirm_password" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
        <div class="text-red-500"><?= error('confirm_password') ?></div>
    </div>
